...
public class SaleFragmentPresenterImp implements IHomePresenterContract.Presenter {

    private IHomePresenterContract.View mView;
    private FirebaseAuth mAuth;
    private static final String TAG = "SaleFragPresenterImp";
    ...
    public SaleFragmentPresenterImp(IHomePresenterContract.View mView, Context context) {
        this.mView = mView;
